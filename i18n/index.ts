...
const translations: Record<SupportedLanguage, Translations> = {
  ...
  fr: {
    ...
    favoritesAccessibilityLabel: 'Lieux favoris', favoritesTitle: 'Lieux favoris', savedFavorites: 'Favoris enregistrés',
    favoritesEmpty: 'Aucun favori pour le moment. Ajoutez ci-dessous votre dernière position enregistrée ou votre position actuelle.',
    favoriteGesturesHint: 'Touchez pour ouvrir · Maintenez pour renommer · Balayez vers la gauche pour supprimer', longPressToRename: 'Maintenez pour renommer',
    ...
    renameFavorite: 'Renommer le favori', favoriteName: 'Nom du favori', save: 'Enregistrer',
    favoritesErrorTitle: 'Impossible de mettre à jour les favoris', favoritesLoadError: 'FindBack n’a pas pu lire vos favoris.', favoritesSaveError: 'FindBack n’a pas pu enregistrer la modification. Réessayez.',
    purchaseTitle: 'Favoris FindBack', purchaseBody: 'Enregistrez tous les lieux où vous souhaitez pouvoir retourner.',
    unlimitedFavorites: 'Nombre illimité de lieux favoris', oneTimePurchase: 'Achat unique', noSubscription: 'Sans abonnement',
    ...
    restoreSuccessTitle: 'Achat restauré', restoreSuccessMessage: 'Les Favoris sont maintenant déverrouillés.',
    restoreNotFoundTitle: 'Aucun achat trouvé', restoreNotFoundMessage: 'La boutique n’a trouvé aucun achat antérieur des Favoris pour ce compte.',
  },
  ja: {
    unknownTime: '時刻不明',
    todayAt: '今日 {time}',
    ...
    favoritesAccessibilityLabel: 'お気に入りの場所', favoritesTitle: 'お気に入りの場所', savedFavorites: '保存済みのお気に入り',
    favoritesEmpty: 'お気に入りはまだありません。最後に保存した位置または現在地を下から追加できます。',
    favoriteGesturesHint: 'タップで開く · 長押しで名前変更 · 左にスワイプで削除', longPressToRename: '長押しで名前を変更',
    addLastSaved: '最後に保存した位置を追加', addCurrent: '現在地を追加', favoriteDeleted: '{name}を削除しました', undo: '元に戻す',
    renameFavorite: 'お気に入りの名前を変更', favoriteName: 'お気に入りの名前', save: '保存',
    favoritesErrorTitle: 'お気に入りを更新できませんでした', favoritesLoadError: 'お気に入りを読み込めませんでした。', favoritesSaveError: '変更を保存できませんでした。もう一度お試しください。',
    purchaseTitle: 'FindBack お気に入り', purchaseBody: '戻りたい場所をすべて保存できます。',
    unlimitedFavorites: 'お気に入りの場所を無制限に保存', oneTimePurchase: '買い切り', noSubscription: 'サブスクリプションなし',
    ...
    restoreSuccessTitle: '購入を復元しました', restoreSuccessMessage: 'お気に入り機能が利用できるようになりました。',
    restoreNotFoundTitle: '購入が見つかりません', restoreNotFoundMessage: 'このアカウントには過去のお気に入り購入が見つかりませんでした。',
  },
  hi: {
    ...
    favoritesAccessibilityLabel: 'पसंदीदा स्थान', favoritesTitle: 'पसंदीदा स्थान', savedFavorites: 'सहेजे गए पसंदीदा',
    favoritesEmpty: 'अभी कोई पसंदीदा स्थान नहीं है। नीचे अंतिम सहेजा गया या वर्तमान स्थान जोड़ें।',
    favoriteGesturesHint: 'खोलने के लिए टैप करें · नाम बदलने के लिए दबाए रखें · हटाने के लिए बाईं ओर स्वाइप करें', longPressToRename: 'नाम बदलने के लिए दबाए रखें',
    ...
    renameFavorite: 'पसंदीदा का नाम बदलें', favoriteName: 'पसंदीदा का नाम', save: 'सहेजें',
    favoritesErrorTitle: 'पसंदीदा अपडेट नहीं हो सके', favoritesLoadError: 'FindBack आपके पसंदीदा नहीं पढ़ सका।', favoritesSaveError: 'FindBack बदलाव सहेज नहीं सका। फिर से प्रयास करें।',
    purchaseTitle: 'FindBack पसंदीदा', purchaseBody: 'उन सभी स्थानों को सहेजें जहाँ आप वापस जाना चाहते हैं।',
    unlimitedFavorites: 'असीमित पसंदीदा स्थान', oneTimePurchase: 'एक बार की खरीदारी', noSubscription: 'कोई सदस्यता नहीं',
    ...
    restoreSuccessTitle: 'खरीदारी पुनर्स्थापित हुई', restoreSuccessMessage: 'पसंदीदा अब अनलॉक है।',
    restoreNotFoundTitle: 'कोई खरीदारी नहीं मिली', restoreNotFoundMessage: 'स्टोर को इस खाते के लिए पसंदीदा की कोई पिछली खरीदारी नहीं मिली।',
  },
  zh: {
    unknownTime: '未知时间',
    todayAt: '今天 {time}',
    ...
    favoritesAccessibilityLabel: '收藏地点', favoritesTitle: '收藏地点', savedFavorites: '已保存的收藏',
    favoritesEmpty: '还没有收藏。请在下方添加上次保存的位置或当前位置。',
    favoriteGesturesHint: '轻点打开 · 长按重命名 · 向左滑动删除', longPressToRename: '长按重命名',
    addLastSaved: '添加上次保存的位置', addCurrent: '添加当前位置', favoriteDeleted: '已删除{name}', undo: '撤销',
    renameFavorite: '重命名收藏', favoriteName: '收藏名称', save: '保存',
    favoritesErrorTitle: '无法更新收藏', favoritesLoadError: 'FindBack 无法读取您的收藏。', favoritesSaveError: 'FindBack 无法保存更改，请重试。',
    purchaseTitle: 'FindBack 收藏', purchaseBody: '保存所有您想再次返回的地点。',
    unlimitedFavorites: '无限收藏地点', oneTimePurchase: '一次性购买', noSubscription: '无需订阅',
    ...
    restoreSuccessTitle: '购买已恢复', restoreSuccessMessage: '收藏功能现已解锁。',
    restoreNotFoundTitle: '未找到购买记录', restoreNotFoundMessage: '商店未找到此账户之前购买收藏功能的记录。',
  },
};
